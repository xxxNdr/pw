...
RICORDATI DI REGISTRARE api.php IN bootstrap/app.php
...
## CREO LE CARTELLE PAGES E COMPONENTS PER ROUTER REACT

## INSTALLO REACT-ROUTER

SERVE PER GESTIRE LA NAVIGAZIONE E IL ROUTING DICHIARATIVO,
DICHIARA CHE ELEMENTO REACT VA MOSTRATO.
DICHIARATIVO = MIGLIORA LA SEMPLIFICAZIONE DEL CODICE E LA MANUTENZIONE

```bash
npm install react-router-dom
```

## CREA LE PAGINE HOME E ORDERS PER REACT E IL COMPONENTE NAVBAR

## CREA MAIN.JSX... NON SCORDARLO... IL PUNTO DI INGRESSO DI REACT IN RESOURCES/JS

## CREA HOME ORDERS COME PAGINE, APP.JSX NAVBAR.JSX CME COMPONENTS
